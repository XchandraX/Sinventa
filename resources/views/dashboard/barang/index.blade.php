    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('barang.index') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-6 mb-3">
                        <select name="kategori" id="kategori_id" class="select2 placeholder form-control">
                            ...
                            @empty
                                <option value="">Data Kategori Tidak Ditemukan!</option>
                            @endforelse
                        </select>
                    </div>
                    ...
                    {{-- kolom filter berdasarkan status --}}
                    <div class="col-lg-2 col-6 mb-3">
                        <select name="status" id="status" class="select2 placeholder form-control">
                            <option value="">Semua Status</option>
                            <option value="Baik" {{ request('status') == 'Baik' ? 'selected' : '' }}>Baik</option>
                            <option value="Rusak Ringan" {{ request('status') == 'Rusak Ringan' ? 'selected' : '' }}>Rusak
                                Ringan</option>
                            <option value="Rusak Berat" {{ request('status') == 'Rusak Berat' ? 'selected' : '' }}>Rusak
                                Berat</option>
            ...
            @if ($barangs->isEmpty())
                ...
                {{-- jika data barang dad didatabase --}}
            @else
                ...
                <div class="table-responsive">
                    <table class="table datanew">
                        ...
                        <tbody>
                            ...
                            {{-- ? tampilan semua data barang satu persatu menggunakan perluangan --}}
